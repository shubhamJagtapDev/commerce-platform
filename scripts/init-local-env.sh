...
identity_registration_intent_hmac_key="$(openssl rand -base64 32)"
catalog_idempotency_hmac_key="$(openssl rand -base64 32)"
...
ensure_value IDENTITY_REGISTRATION_INTENT_HMAC_KEY "$identity_registration_intent_hmac_key"
ensure_value CATALOG_IDEMPOTENCY_HMAC_KEY "$catalog_idempotency_hmac_key"
